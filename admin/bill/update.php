    ...
    <div class="col-12">
        ...
        <div class="card mb-4">
            ...
            <div class="form-group row">
                ...
                <label for="id" class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Mã loại</label>
                <div class="col-sm-9">
                    <input type="text" name="id" disabled>
                </div>
            </div>
            <div class="form-group row">
                <label for="bill_status" class="text-uppercase text-xxs text-xxs font-weight-bolder opacity-7">Trạng thái đơn hàng</label>
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="bill_status" value="<?php if(isset($bill_status)&&($bill_status!="")) echo $bill_status;?>" required>
                </div>
            </div>
